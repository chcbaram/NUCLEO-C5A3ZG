...
if(CMAKE_BUILD_TYPE STREQUAL "debug_GCC_STM32C5A3ZGT6")
  ...
  target_include_directories(${CMAKE_PROJECT_NAME} PUBLIC  arch/cmsis/CMSIS/Core/Include generated/hal stm32c5xx_dfp/Include stm32c5xx_drivers/hal stm32c5xx_drivers/ll stm32c5xx_drivers/timebases user_modifiable/_debug_GCC_STM32C5A3ZGT6)
  target_compile_definitions(${CMAKE_PROJECT_NAME} PUBLIC STM32C5A3xx _RTE_)
  target_link_options(${CMAKE_PROJECT_NAME} PUBLIC -Wl,-Map=././stm32-c5.map -Wl,--gc-sections -Wl,--start-group -lc -lm -Wl,--end-group -static --specs=nano.specs --specs=nosys.specs ${CC_SECURE})
